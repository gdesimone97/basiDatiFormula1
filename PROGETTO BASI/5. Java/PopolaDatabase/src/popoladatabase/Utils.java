...
public class Utils {
    ...
    public static void main(String args[]) {
        int x = 0;
        int num = 100; //NUM indica il numero di righe da inserire
        String name;
        String surName;
        String codice;
        ...
        try (BufferedWriter w = new BufferedWriter(new FileWriter("personale.txt"))) {
...
//              il 20% è STAFF MURETTO
//              il 40% è MECCANICO
//              il 30% è INGEGNERE
//              il 10% è DIRIGENTE
                if (x >= 0 & x < num * 20 / 100) {
                    profession = "Staff Muretto";
                } else if (x >= num * 20 / 100 & x < num * 60 / 100) {
                    profession = "Meccanico";
                } else if (x >= num * 60 / 100 & x < num * 90 / 100) {
                    profession = "Ingegnere";
                } else if (x >= num * 90 / 100 & x < num) {
